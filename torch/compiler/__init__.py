...
def _enable_fullgraph_package(*, path: str):
    ...
    prev_cpp_wrapper, torch._inductor.config.cpp_wrapper = torch._inductor.config.cpp_wrapper, True
    prev_package, torch._inductor.config.aot_inductor.package = torch._inductor.config.aot_inductor.package, True
...
def _disable_fullgraph_package(flags) -> None:
    global _FULLGRAPH_PACKAGE
    torch._inductor.config.cpp_wrapper, torch._inductor.config.aot_inductor.package = flags
